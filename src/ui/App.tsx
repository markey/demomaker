...
export const App: React.FC = () => {
  return (
    <div className="app-grid" style={{display:'grid', gridTemplateRows:'auto 1fr auto', gridTemplateColumns:'260px 1fr 300px', height:'100%', width:'100%', gap: '1px', background:'#161618', overflow:'hidden'}}>
      ...
      <div style={{background:'#0a0a0b', overflow:'hidden'}}><Preview/></div>
